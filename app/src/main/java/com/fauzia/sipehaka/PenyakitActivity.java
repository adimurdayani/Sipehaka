...
//    memberi akses semua halaman dashboar penyakit
    public static PenyakitActivity pa;
...
//        panggil komponen
        listView = (ListView)findViewById(R.id.listData2);
        btnAdd = (FloatingActionButton)findViewById(R.id.btn_add2);
        imageView = findViewById(R.id.imageHome2);

        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PenyakitActivity.this,AdminActivity.class));
            }
        });
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PenyakitActivity.this,TambahDataPenyakitActivity.class));
            }
        });
...
//                        findViewById(R.id.imageViewPrint2)
...
//                        Toast.makeText(PenyakitActivity.this,""+permissionDeniedResponse.getPermissionName(), Toast.LENGTH_SHORT).show();
//                    }
//
//                    @Override
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0:
                                Intent lihatData = new Intent(getApplicationContext(), LihatDataPenyakitActivity.class);
                                lihatData.putExtra("judul", selection);
                                startActivity(lihatData);
                                break;
                            case 1:
                                Intent lihatDataId = new Intent(getApplicationContext(), UpdateDataPenyakitActivity.class);
                                lihatDataId.putExtra("judul", selection);
                                startActivity(lihatDataId);
                                break;
                            case 2:
                                SQLiteDatabase db = helper.getWritableDatabase();
                                db.execSQL("delete from penyakit where judul = '" + selection + "'");
                                RefreshList();
                                break;
                        }
                    }
