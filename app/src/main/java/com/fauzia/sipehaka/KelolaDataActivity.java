...
public class KelolaDataActivity extends AppCompatActivity {
    ...
    DataHelper dbcenter;
    public static KelolaDataActivity ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(KelolaDataActivity.this,InputActivity.class));
            }
        });
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KelolaDataActivity.this,AdminActivity.class));
            }
        });

        dialog = new AlertDialog.Builder(this).setCancelable(false).setMessage("Please waith").create();
...
//                        findViewById(R.id.imageViewPrint)
...
//                        Toast.makeText(KelolaDataActivity.this,""+permissionDeniedResponse.getPermissionName(), Toast.LENGTH_SHORT).show();
//                    }
//
//                    @Override
...
//fungsi menampilkan semua database
        ...
        cursor = db.rawQuery("SELECT * FROM sistempakar", null);
...
//        fungsi menampilkan popup data
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(KelolaDataActivity.this);
                ...
                builder.setItems(dialogitem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case 0:
                                Intent lihatData = new Intent(getApplicationContext(), LihatDataKakaoActivity.class);
                                lihatData.putExtra("judul", selection);
                                startActivity(lihatData);
                                break;
                            case 1:
                                Intent lihatDataId = new Intent(getApplicationContext(), UpdateDataKakaoActivity.class);
                                lihatDataId.putExtra("judul", selection);
                                startActivity(lihatDataId);
                                break;
                            case 2:
                                SQLiteDatabase db = dbcenter.getWritableDatabase();
                                db.execSQL("delete from sistempakar where judul = '" + selection + "'");
                                RefreshList();
                                break;
                        }
                    }
